...
EbayTemplateGeneralShippingHandler.prototype = Object.extend(new CommonHandler(), {
    ...
    setShippingRateVisibility: function()
    {
        ...
        if (self.shippingRateSites.indexOf(self.marketplaceId) == -1) {
            $('magento_block_ebay_template_general_shipping_rate').hide();
        } else {
            $('magento_block_ebay_template_general_shipping_rate').show();
        }
    },
    ...
    package_size_ebay_change: function()
    {
        ...
        EbayTemplateGeneralShippingHandlerObj.setDimensionVisibility(showDimension);
    },
