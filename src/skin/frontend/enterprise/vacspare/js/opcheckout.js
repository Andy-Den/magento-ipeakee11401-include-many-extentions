...
Checkout.prototype = {
    ...
    reloadProgressBlock: function(){
        ...
        var updater = new Ajax.Updater('col-right-opcheckout', this.progressUrl, {method: 'get', onFailure: this.ajaxFailure.bind(this), onSuccess:function(){updateProgress(); setTimeout('updateProgress()',1000),setTimeout('updateProgress()',2000)}});
    ...
    gotoSection: function(section)
    {
        ...
        section.down('div h2').removeClassName('step-next');
        ...
        if (response.error){
            if ((typeof response.message) == 'string') {
                ...
                if (window.billingRegionUpdater) {
                    ...
                    //GOD-1484, if vacspare want do the same as godfreys, uncomment next line.
