...
document.observe("dom:loaded", function() {
    ...
    var loadMore = Class.create({
        initialize: function (list, href, pattern) {
            ...
            this.list = list;
            this.list.insert({ after : '<div class="more"><button class="button btn-more"><span id="more_button" class="more-button"><span>SHow more items</span></span></button></div>'});
...
//    if ( $$('.home-slide-wp .home-slide li').size() > 1 ) {
//         var homeGallery = new Carousel($$('.home-slide-wp .home-slide')[0], $$('.home-slide ul')[0], {
//            visibleElements: 1,
//            preventDefaults: false
//        }).init();
//    }
