...
var OneStepCheckoutLoginPopup = Class.create({
    initialize: function(options) {
        ...
        this.login_handler = function(e) {
            ...
            var onestepcheckoutforgotform = new VarienForm('onestepcheckout-login-form');
            
             if(!onestepcheckoutforgotform.validator.validate())
                return false;
        ...
        this.forgot_password_handler = function(e) {
            var onestepcheckoutloginform   = new VarienForm('onestepcheckout-forgot-form');
            if(!onestepcheckoutloginform.validator.validate())
                return false;
