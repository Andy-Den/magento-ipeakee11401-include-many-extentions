...
checkproductlAjaxRequests: function(url,id,original_url,itemid) {
           ...
           if (blocks) {
            try {
                blocks.each(function(block) {
                    if (block.name) {
                        if ($('allajax_view_compare')) {
                            $('allajax_view_compare').hide();
                        }
                        if ($('allajax_view_cart')) {
                            $('allajax_view_cart').show();
                        }
                        ...
                        }else if (block.name == 'ajaxwishlist_compare_custom'){
                            if ($('block_header_top_right_compare_custom') && block.html != '') {
                                $('block_header_top_right_compare_custom').update(block.html);
                            }
                            if ($('allajax_view_cart')) {
                                $('allajax_view_cart').hide();
                            }
                            if ($('allajax_view_compare')) {
                                $('allajax_view_compare').show();
                            }
    ...
    showWaitingPopup: function(id){
        var pro_image = jQuery('.allajax-imagesfetch-'+id).first().attr('src');
        var pro_name = jQuery('.allajax-namefetch-'+id+' a').first().text();
        var pro_url = jQuery('.allajax-namefetch-'+id+' a').first().attr('href');
        var pro_review = jQuery('.allajax-productdatafetch-'+id+' .ratings').first().html();
        var pro_price = jQuery('.allajax-productdatafetch-'+id+' .price-box').first().html();
        ...
        jQuery('#ajax-loading-lightbx-pro-name-respond').html(pro_name);
