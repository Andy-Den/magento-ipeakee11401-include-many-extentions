...
Enterprise.Bundle = {
     ...
     reloadPrice: function () {
        ...
        var result = Enterprise.Bundle.productReloadPrice(this);
        /*
     ...
     productReloadPrice: function(_this) {
        
        var calculatedPrice = 0;
        var dispositionPrice = 0;
        var includeTaxPrice = 0;
        for (var option in _this.config.selected) {
            if (_this.config.options[option]) {
                for (var i=0; i < _this.config.selected[option].length; i++) {
                    var prices = _this.selectionPrice(option, _this.config.selected[option][i]);
