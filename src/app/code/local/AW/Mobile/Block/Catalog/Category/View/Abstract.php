 ...
 */
abstract class AW_Mobile_Block_Catalog_Category_View_Abstract extends Mage_Core_Block_Template {
	...
	protected function _getSelectBlock()
	{
		...
		if (is_null($block)) {
			$block_obj = Mage::getBlockSingleton('balance_accessory/search_form');
			$block = $block_obj->getLayout()->createBlock('core/html_select');
