...
class AW_Islider_Block_Adminhtml_Widget_Blockchooser extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    public function prepareElementHtml(Varien_Data_Form_Element_Abstract $element) {
        ...
        $sourceUrl = $this->getUrl('adminhtml/awislideradmin_widget/blockchooser', array('uniq_id' => $uniqId));
    ...
    public function getGridUrl() {
        return $this->getUrl('adminhtml/awislideradmin_widget/blockchooser', array('_current'=>true));
    }
}
