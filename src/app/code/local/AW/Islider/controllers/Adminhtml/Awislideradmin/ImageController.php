 ...
 */
class AW_Islider_Adminhtml_Awislideradmin_ImageController extends Mage_Adminhtml_Controller_Action {
    ...
    protected function saveimageAction() {
        ...
        if($_request->getParam('image_type') == AW_Islider_Model_Source_Images_Type::FILE) {
            ...
            if(isset($_FILES['image_file']['name']) && $_FILES['image_file']['name']) {
                if(Mage::helper('awislider/files')->isAllowedImage($_FILES['image_file']['tmp_name'])) {
