...
class Balance_Datafeed_Block_Adminhtml_Datafeed_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs {
    ...
    protected function _beforeToHtml() {
        $this->addTab('form_configuration', array(
            ...
            'content' => $this->getLayout()
                    ->createBlock('datafeed/adminhtml_datafeed_edit_tab_configuration')
                    ->toHtml()
        ));
        $this->addTab('form_category', array(
            ...
            'content' => $this->getLayout()
                    ->createBlock('datafeed/adminhtml_datafeed_edit_tab_categories')
                    ->toHtml()
        ));
        $this->addTab('form_filter', array(
            ...
            'content' => $this->getLayout()
                    ->createBlock('datafeed/adminhtml_datafeed_edit_tab_filters')
                    ->toHtml()
        ));
        $this->addTab('form_cron', array(
            ...
            'content' => $this->getLayout()
                    ->createBlock('datafeed/adminhtml_datafeed_edit_tab_cron')
                    ->toHtml()
        ));
