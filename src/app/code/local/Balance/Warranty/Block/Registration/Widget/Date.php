<?php
/*
 * A date widget for the warranty registration 
 * 
 * @category    Balance
 * @package     Balance_Warranty
 */
class Balance_Warranty_Block_Registration_Widget_Date extends Mage_Customer_Block_Widget_Abstract
{
    /**
     * Date inputs
     *
    ...
    public function _construct()
    {
        ...
        $this->setTemplate('warranty/registration/widget/date.phtml');
    }
