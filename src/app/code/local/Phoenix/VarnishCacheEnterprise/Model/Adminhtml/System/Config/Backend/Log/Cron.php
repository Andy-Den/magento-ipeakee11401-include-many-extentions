...
class Phoenix_VarnishCacheEnterprise_Model_Adminhtml_System_Config_Backend_Log_Cron
    extends Mage_Core_Model_Config_Data
{
    const CRON_STRING_PATH  = 'crontab/jobs/varnishcache_crawler/schedule/cron_expr';
    const CRON_MODEL_PATH   = 'crontab/jobs/varnishcache_crawler/run/model';
    ...
    {
        $cronExprString = $this->getData('groups/varnishcache_crawler/fields/cron_expr/value');
        try {
