 ...
 */
class Innoexts_Warehouse_Helper_Catalog_Product 
    extends Mage_Core_Helper_Abstract 
{
    ...
    protected function saveChildData(
        $product, $dataTableName, 
        $dataAttributeCode, $dataKeyAttributeCode, $dataValueAttributeCode, $dataValueType = 'string'
    )
    {
