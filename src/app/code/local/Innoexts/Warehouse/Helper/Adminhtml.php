 ...
 */
class Innoexts_Warehouse_Helper_Adminhtml 
    extends Mage_Core_Helper_Abstract 
{
    ...
    public function addStockOrderGridColumn($grid)
    {
        ...
        $grid->addColumnAfter('stock_ids', array(
    ...
    public function addBatchPriceProductGridColumn($grid)
    {
        ...
        $grid->addColumn('batch_prices', array(
    ...
    public function addQtyProductLowstockGridColumns($grid)
    {
        ...
        foreach ($stockIds as $stockId) {
            ...
            $grid->addColumn($fieldName, array(
                'header'    => sprintf(
                    $helper->__('%s Qty'), 
