...
$connection->addConstraint(
    'FK_SALES_QUOTE_ITEM_STOCK', $salesQuoteItemTable, 'stock_id', $catalogInventoryStockTable, 'stock_id', 'set null'
);
$connection->addColumn($salesQuoteItemTable, 'warehouse_id', 'smallint(6) unsigned null default null');
$connection->addConstraint(
    'FK_SALES_QUOTE_ITEM_WAREHOUSE', $salesQuoteItemTable, 'warehouse_id', $warehouseTable, 'warehouse_id', 'set null'
);

$connection->addColumn($salesOrderItemTable, 'stock_id', 'smallint(6) unsigned null default null');
$connection->addConstraint(
    'FK_SALES_ORDER_ITEM_STOCK', $salesOrderItemTable, 'stock_id', $catalogInventoryStockTable, 'stock_id', 'set null'
);
$connection->addColumn($salesOrderItemTable, 'warehouse_id', 'smallint(6) unsigned null default null');
$connection->addConstraint(
    'FK_SALES_ORDER_ITEM_WAREHOUSE', $salesOrderItemTable, 'warehouse_id', $warehouseTable, 'warehouse_id', 'set null'
);

$connection->addColumn($salesInvoiceItemTable, 'stock_id', 'smallint(6) unsigned null default null');
$connection->addConstraint(
    'FK_SALES_INVOICE_ITEM_STOCK', $salesInvoiceItemTable, 'stock_id', $catalogInventoryStockTable, 'stock_id', 'set null'
);
$connection->addColumn($salesInvoiceItemTable, 'warehouse_id', 'smallint(6) unsigned null default null');
$connection->addConstraint(
    'FK_SALES_INVOICE_ITEM_WAREHOUSE', $salesInvoiceItemTable, 'warehouse_id', $warehouseTable, 'warehouse_id', 'set null'
);

$connection->addColumn($salesShipmentItemTable, 'stock_id', 'smallint(6) unsigned null default null');
$connection->addConstraint(
    'FK_SALES_SHIPMENT_ITEM_STOCK', $salesShipmentItemTable, 'stock_id', $catalogInventoryStockTable, 'stock_id', 'set null'
);
$connection->addColumn($salesShipmentItemTable, 'warehouse_id', 'smallint(6) unsigned null default null');
$connection->addConstraint(
    'FK_SALES_SHIPMENT_ITEM_WAREHOUSE', $salesShipmentItemTable, 'warehouse_id', $warehouseTable, 'warehouse_id', 'set null'
);

$connection->addColumn($salesCreditmemoItemTable, 'stock_id', 'smallint(6) unsigned null default null');
$connection->addConstraint(
    'FK_SALES_CREDITMEMO_ITEM_STOCK', $salesCreditmemoItemTable, 'stock_id', $catalogInventoryStockTable, 'stock_id', 'set null'
);
$connection->addColumn($salesCreditmemoItemTable, 'warehouse_id', 'smallint(6) unsigned null default null');
$connection->addConstraint(
    'FK_SALES_CREDITMEMO_ITEM_WAREHOUSE', $salesCreditmemoItemTable, 'warehouse_id', $warehouseTable, 'warehouse_id', 'set null'
);
...
");
$connection->addConstraint(
    'FK_WAREHOUSE_ORDER_GRID_ENTITY_ID', $warehouseOrderGridWarehouseTable, 'entity_id', $salesOrderGridTable, 'entity_id'
);
$connection->addConstraint(
    'FK_WAREHOUSE_ORDER_GRID_WAREHOUSE_ID', $warehouseOrderGridWarehouseTable, 'warehouse_id', $warehouseTable, 'warehouse_id'
);
...
");
$connection->addConstraint(
    'FK_WAREHOUSE_SHIPMENT_GRID_ENTITY_ID', $warehouseShipmentGridWarehouseTable, 'entity_id', $salesShipmentGridTable, 'entity_id'
);
$connection->addConstraint(
    'FK_WAREHOUSE_SHIPMENT_GRID_WAREHOUSE_ID', $warehouseShipmentGridWarehouseTable, 'warehouse_id', $warehouseTable, 'warehouse_id'
);
...
");
$connection->addConstraint(
    'FK_WAREHOUSE_CREDITMEMO_GRID_ENTITY_ID', $warehouseCreditmemoGridWarehouseTable, 'entity_id', $salesCreditmemoGridTable, 'entity_id'
);
$connection->addConstraint(
    'FK_WAREHOUSE_CREDITMEMO_GRID_WAREHOUSE_ID', $warehouseCreditmemoGridWarehouseTable, 'warehouse_id', $warehouseTable, 'warehouse_id'
);
...
");
$connection->addConstraint(
    'FK_WAREHOUSE_INVOICE_GRID_ENTITY_ID', $warehouseInvoiceGridWarehouseTable, 'entity_id', $salesInvoiceGridTable, 'entity_id'
);
$connection->addConstraint(
    'FK_WAREHOUSE_INVOICE_GRID_WAREHOUSE_ID', $warehouseInvoiceGridWarehouseTable, 'warehouse_id', $warehouseTable, 'warehouse_id'
);

$connection->addColumn($shippingTablerateTable, 'warehouse_id', "smallint(6) unsigned NOT NULL default '0'");

$connection->addKey($shippingTablerateTable, 'dest_country', array(
