...
$installer->addAttribute('customer_address', 'warehouse_id', array(
    'label'            => 'Warehouse', 
    'visible'          => '0', 
    'required'         => '0', 
    'type'             => 'int', 
...
$installer->addAttribute('customer_address', 'stock_id', array(
    'label'            => 'Stock', 
    'visible'          => '0', 
    'required'         => '0', 
    'type'             => 'int', 
...
$connection->addConstraint(
    'FK_SALES_QUOTE_ADDRESS_STOCK', $salesQuoteAddressTable, 'stock_id', $catalogInventoryStockTable, 'stock_id', 'set null'
);
$connection->addColumn($salesQuoteAddressTable, 'warehouse_id', 'smallint(6) unsigned null default null');
$connection->addConstraint(
    'FK_SALES_QUOTE_ADDRESS_WAREHOUSE', $salesQuoteAddressTable, 'warehouse_id', $warehouseTable, 'warehouse_id', 'set null'
);

$connection->addColumn($salesOrderAddressTable, 'stock_id', 'smallint(6) unsigned null default null');
$connection->addConstraint(
    'FK_SALES_ORDER_ADDRESS_STOCK', $salesOrderAddressTable, 'stock_id', $catalogInventoryStockTable, 'stock_id', 'set null'
);
$connection->addColumn($salesOrderAddressTable, 'warehouse_id', 'smallint(6) unsigned null default null');
$connection->addConstraint(
    'FK_SALES_ORDER_ADDRESS_WAREHOUSE', $salesOrderAddressTable, 'warehouse_id', $warehouseTable, 'warehouse_id', 'set null'
);
