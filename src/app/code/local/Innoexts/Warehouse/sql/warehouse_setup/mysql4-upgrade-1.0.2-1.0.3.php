...
$connection->addConstraint(
    'FK_CATALOG_PRODUCT_INDEX_PRICE_STOCK', $catalogProductIndexPriceTable, 'stock_id', $catalogInventoryStockTable, 'stock_id'
);
...
$connection->addKey($catalogProductIndexPriceBundleSelectionIdxTable, 'PRIMARY', array(
...
$connection->addKey($catalogProductIndexPriceBundleSelectionTmpTable, 'PRIMARY', array(
    'entity_id', 'customer_group_id', 'website_id', 'option_id', 'selection_id', 'stock_id'
), 'primary');
...
$connection->addKey($catalogProductIndexPriceBundleOptionIdxTable, 'PRIMARY', array(
...
$connection->addKey($catalogProductIndexPriceBundleOptionTmpTable, 'PRIMARY', array(
    'entity_id', 'customer_group_id', 'website_id', 'option_id', 'stock_id'
), 'primary');
...
$connection->addKey($catalogProductIndexPriceOptionAggregateIdxTable, 'PRIMARY', array(
    'entity_id', 'customer_group_id', 'website_id', 'option_id', 'stock_id'
), 'primary');
...
$connection->addKey($catalogProductIndexPriceOptionAggregateTmpTable, 'PRIMARY', array(
    'entity_id', 'customer_group_id', 'website_id', 'option_id', 'stock_id'
), 'primary');
...
$connection->addKey($catalogProductIndexPriceOptionIdxTable, 'PRIMARY', array(
...
$connection->addKey($catalogProductIndexPriceOptionTmpTable, 'PRIMARY', array(
    'entity_id', 'customer_group_id', 'website_id', 'stock_id'
), 'primary');
...
$connection->addKey($catalogProductIndexPriceDownloadableIdxTable, 'PRIMARY', array(
    'entity_id', 'customer_group_id', 'website_id', 'stock_id'
), 'primary');
...
$connection->addKey($catalogProductIndexPriceDownloadableTmpTable, 'PRIMARY', array(
    'entity_id', 'customer_group_id', 'website_id', 'stock_id'
), 'primary');
...
$connection->addKey($catalogProductIndexPriceCfgOptionAggregateIdxTable, 'PRIMARY', array(
...
$connection->addKey($catalogProductIndexPriceCfgOptionAggregateTmpTable, 'PRIMARY', array(
    'parent_id', 'child_id', 'customer_group_id', 'website_id', 'stock_id'
), 'primary');
...
$connection->addKey($catalogProductIndexPriceCfgOptionIdxTable, 'PRIMARY', array(
    'entity_id', 'customer_group_id', 'website_id', 'stock_id'
), 'primary');
...
$connection->addKey($catalogProductIndexPriceCfgOptionTmpTable, 'PRIMARY', array(
    'entity_id', 'customer_group_id', 'website_id', 'stock_id'
), 'primary');
