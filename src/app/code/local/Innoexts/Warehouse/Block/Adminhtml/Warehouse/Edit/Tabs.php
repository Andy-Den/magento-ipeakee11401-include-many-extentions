 ...
 */
class Innoexts_Warehouse_Block_Adminhtml_Warehouse_Edit_Tabs 
    extends Innoexts_Core_Block_Adminhtml_Widget_Tabs 
{
    /**
     * Model name
     * 
