...
/**
 * Recurring profile items
 *
 * @category   Innoexts
 * @package    Innoexts_Warehouse
 * @author     Innoexts Team <developers@innoexts.com>
 */
class Innoexts_Warehouse_Block_Adminhtml_Sales_Recurring_Profile_View_Items 
    extends Mage_Adminhtml_Block_Sales_Recurring_Profile_View_Items 
{
    /**
