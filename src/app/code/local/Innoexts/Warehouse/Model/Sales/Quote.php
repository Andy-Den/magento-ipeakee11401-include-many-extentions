 ...
 */
class Innoexts_Warehouse_Model_Sales_Quote 
    extends Innoexts_CustomerLocator_Model_Sales_Quote 
{
    /**
    ...
    {
        # $this->debugObject($this);
        # $this->debugObject($this->getShippingAddress());
        foreach ($this->getItemsCollection() as $item) {
            $this->debugObject($item);
            # $this->debugObject($item->getProduct());
        }
        echo '---<br/>';
        return $this;
    }
