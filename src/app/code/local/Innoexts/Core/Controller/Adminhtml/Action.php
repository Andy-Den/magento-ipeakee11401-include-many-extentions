 ...
 */
class Innoexts_Core_Controller_Adminhtml_Action 
    extends Mage_Adminhtml_Controller_Action 
{
    ...
    protected function _editAction(
        $type, $isAjax, $menu, $idParamName, $indexActionName, $newMessage, $editMessage, 
    ...
    protected function _saveAction(
        $type, $isAjax, $idParamName, $indexActionName, $editActionName, $savedMessage, $errorMessage
    )
    {
        $adminhtmlSession   = $this->_getSession();
        $request            = $this->getRequest();
    ...
    protected function _deleteAction(
        $type, $isAjax, $idParamName, $indexActionName, $editActionName, $notFoundMessage, $deletedMessage
    ) 
    {
        $adminhtmlSession   = $this->_getSession();
        $request            = $this->getRequest();
