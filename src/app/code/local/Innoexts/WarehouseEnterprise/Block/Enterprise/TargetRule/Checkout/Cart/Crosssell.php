 ...
 */
class Innoexts_WarehouseEnterprise_Block_Enterprise_TargetRule_Checkout_Cart_Crosssell 
    extends Enterprise_TargetRule_Block_Checkout_Cart_Crosssell 
{
    /**
    ...
    protected function _getTargetLinkCollection()
    {
        ...
        $stockStatus->setStockId($assignmentMethodHelper->getQuoteStockId());
