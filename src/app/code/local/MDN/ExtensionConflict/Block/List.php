...
class MDN_ExtensionConflict_Block_List extends Mage_Adminhtml_Block_Widget_Grid
{
   ...
   /**
    ...
    {
    	return $this->getUrl('adminhtml/mdn_extensionconflict_admin/refresh');
    }
    
    public function getUploadUrl()
    {
    	return $this->getUrl('adminhtml/mdn_extensionconflict_admin/upload');
    }
    
    public function getDeleteVirtualModuleUrl()
    {
    	return $this->getUrl('adminhtml/mdn_extensionconflict_admin/deletevirtualmodule');
    }
