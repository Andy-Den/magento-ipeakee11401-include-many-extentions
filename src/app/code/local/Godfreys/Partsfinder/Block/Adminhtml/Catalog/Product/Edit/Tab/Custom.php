<?php
/**
 * Warranty products admin grid
 *
 * @category   Mage
 * @package    Mage_Adminhtml
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Godfreys_Partsfinder_Block_Adminhtml_Catalog_Product_Edit_Tab_Custom extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
    ...
    protected function _getSelectedProducts()
    {
		...
		while ($row = $value->fetch()){
			$products[] = $row['linked_product_id'];
		};
		//echo 'SANDEEP<pre>';print_r($products);die;
        return $products;
    }
}