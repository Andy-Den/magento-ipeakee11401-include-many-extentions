...
<div class="grid12-4 no-left-gutter newletters">
				...
				<div class="grid12-3 locator">
					...
					<form method="get" action="/locator/search/" name="store_locator_form" class="footer-form" id="store_locator_form">
						<input type="text" onblur="if (this.value=='') this.value = this.defaultValue" onfocus="if (this.value==this.defaultValue) this.value = ''" value="Enter postcode" name="s" class="input-text required-entry">
