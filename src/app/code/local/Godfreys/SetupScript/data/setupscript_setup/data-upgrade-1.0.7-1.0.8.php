...
try {
	...
	<div class="nav-col">
		...
		<h4 class="desktop"><a style="text-decoration: none;" href="/vacuum-cleaner-parts/accessories">Accessory Finder</a></h4>
	</div>
	<div class=" nav-col">
...
EOD;
    ...
    //==========================================================================
    // Block Footer Column static Block | Godfreys
    //==========================================================================
    $blockTitle = "Block Footer Column";
    $blockIdentifier = "block_footer_column1";
    $blockStores = array(0);
    $blockIsActive = 1;
    $blockContent = <<<EOD
	<div id="footer-links">{{block type="cms/block" block_id="footer-links"}}</div>
{{block type="cms/block" block_id="live_chat"}}
EOD;
    $block = Mage::getModel('cms/block')->load($blockIdentifier);
    if ($block->getId() == 0)
    {
