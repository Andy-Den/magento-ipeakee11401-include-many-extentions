...
try {
    ...
    //==========================================================================
    // 404_reasons static Block | Godfreys
    //==========================================================================
    ...
    $blockContent = <<<EOD
        <div class="left-wrap">
                                    ...
                                    <p>You can <a href="javascript:history.back()"> go back to the previous page</a> you were on, or <a href="/"> return to the homepage</a></p>
</div>
EOD;
