...
<div class="contact-content">
    ...
    <form id="form-validate" class="wufoo topLabel page" action="https://godfreysvacuums.wufoo.com/forms/q7x3z9/#public" method="post" enctype="multipart/form-data">
        <ul>
            ...
            <li id="foli20" class="notranslate"><label id="title20" class="desc " for="Field20">Postcode</label>
                <div><input id="Field20" class="input-text field text nospin small validate-number" tabindex="4" type="text" name="Field20" maxlength="255" /></div>
            </li>
...
<div class="contact-download">
    <div class="contact-infor">
        <p>Sales &amp; Customer Service <br /> <span class="contact-phone">1300 815 270</span></p>
    </div>
