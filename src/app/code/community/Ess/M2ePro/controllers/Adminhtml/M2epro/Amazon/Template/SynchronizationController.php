...
class Ess_M2ePro_Adminhtml_M2epro_Amazon_Template_SynchronizationController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    //#############################################
    ...
    public function saveAction()
    {
        ...
        if ($post['relist_schedule_type'] == Ess_M2ePro_Model_Amazon_Template_Synchronization::RELIST_SCHEDULE_TYPE_WEEK) {
