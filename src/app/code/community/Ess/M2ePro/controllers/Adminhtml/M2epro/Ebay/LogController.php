...
class Ess_M2ePro_Adminhtml_M2epro_Ebay_LogController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    //#############################################
    ...
    public function listingOtherGridAction()
    {
        ...
        $response = $this->loadLayout()->getLayout()->createBlock('M2ePro/adminhtml_ebay_listing_other_log_grid')->toHtml();
