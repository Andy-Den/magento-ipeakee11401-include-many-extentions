...
class Ess_M2ePro_Adminhtml_M2epro_ListingController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    //#############################################
    ...
    public function indexAction()
    {
        ...
        $this->_initAction()
             ->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_listing'))
             ->renderLayout();
    }
    ...
    {
        Mage::helper('M2ePro')->setGlobalValue('componentMode', $this->getRequest()->getParam('componentMode'));
        Mage::helper('M2ePro')->setGlobalValue('accountId', $this->getRequest()->getParam('accountId'));
        Mage::helper('M2ePro')->setGlobalValue('marketplaceId', $this->getRequest()->getParam('marketplaceId'));
        Mage::helper('M2ePro')->setGlobalValue('attrSetId', json_decode($this->getRequest()->getParam('attrSetId')));
        Mage::helper('M2ePro')->setGlobalValue('ignoreListings', json_decode($this->getRequest()->getParam('ignoreListings')));
    ...
    public function prepareMoveToListingAction()
    {
        ...
        exit(json_encode(array(
            ...
            'attrSetId' => json_encode($attributeSets)
        )));
    }
    ...
    public function goToSellingFormatTemplateAction()
    {
        ...
        $this->_redirect("*/adminhtml_{$model->getComponentMode()}_template_sellingFormat/edit", array('id' => $model->getData('template_selling_format_id'),'back'=>Mage::helper('M2ePro')->getBackUrlParam('list')));
    }
    ...
    public function goToGeneralTemplateAction()
	{
        ...
        $this->_redirect("*/adminhtml_{$model->getComponentMode()}_template_general/edit", array('id' => $model->getData('template_general_id'),'back'=>Mage::helper('M2ePro')->getBackUrlParam('list')));
    }
    ...
    public function goToDescriptionTemplateAction()
    {
        ...
        $this->_redirect("*/adminhtml_{$model->getComponentMode()}_template_description/edit", array('id' => $model->getData('template_description_id'),'back'=>Mage::helper('M2ePro')->getBackUrlParam('list')));
    }
    ...
    public function goToSynchronizationTemplateAction()
    {
        ...
        $this->_redirect("*/adminhtml_{$model->getComponentMode()}_template_synchronization/edit", array('id' => $model->getData('template_synchronization_id'),'back'=>Mage::helper('M2ePro')->getBackUrlParam('list')));
    }
