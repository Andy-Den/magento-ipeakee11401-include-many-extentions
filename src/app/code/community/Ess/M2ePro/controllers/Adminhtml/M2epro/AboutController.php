...
class Ess_M2ePro_Adminhtml_M2epro_AboutController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    //#############################################
    ...
    public function manageDbTableGridAction()
    {
        ...
        $response = $this->loadLayout()->getLayout()->createBlock('M2ePro/adminhtml_about_manageDbTable_grid')->toHtml();
