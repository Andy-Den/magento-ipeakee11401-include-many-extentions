...
class Ess_M2ePro_Adminhtml_M2epro_Ebay_ListingController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    //#############################################
    ...
    public function goToEbayAction()
    {
        ...
        $listingProduct = Mage::getModel('M2ePro/Ebay_Listing_Product')->getInstanceByEbayItem($itemId);
        ...
        $url = Mage::helper('M2ePro/Component_Ebay')->getItemUrl($itemId,
    ...
    public function viewAction()
    {
        ...
        //----------------------------
        $lockItem = Mage::getModel('M2ePro/Listing_LockItem',array('id' => $id, 'component' => Ess_M2ePro_Helper_Component_Ebay::NICK));
        if ($lockItem->isExist()) {
    ...
    public function editAction()
    {
        ...
        $this->_initAction()
             ->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_ebay_listing_edit'))
             ->renderLayout();
    }
    ...
    public function productGridAction()
    {
        ...
        $response = $this->loadLayout()->getLayout()->createBlock('M2ePro/adminhtml_ebay_listing_product_grid')->toHtml();
        $this->getResponse()->setBody($response);
    }
    ...
    {
        exit($this->processConnector(Ess_M2ePro_Model_Connector_Server_Ebay_Item_Dispatcher::ACTION_STOP, array('remove' => true)));
    }
