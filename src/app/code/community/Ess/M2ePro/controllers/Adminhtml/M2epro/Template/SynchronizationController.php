...
class Ess_M2ePro_Adminhtml_M2epro_Template_SynchronizationController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    //#############################################
    ...
    public function editAction()
    {
        ...
        return $this->_redirect("*/adminhtml_{$template->getComponentMode()}_template_synchronization/edit", array('id'=>$id));
    }
