...
class Ess_M2ePro_Adminhtml_M2epro_ConfigController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    //#############################################
    ...
    public function saveAction()
    {
        ...
        if ($mode == 'edit') {
            ...
            Mage::helper('M2ePro')->getGlobalValue('config_mode') == 'ess'    && $ormModelConfig = 'M2ePro/Config_Ess';
            Mage::helper('M2ePro')->getGlobalValue('config_mode') == 'm2epro' && $ormModelConfig = 'M2ePro/Config_Module';
