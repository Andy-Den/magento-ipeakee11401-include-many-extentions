...
class Ess_M2ePro_Adminhtml_M2epro_Amazon_Template_SellingFormatController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    //#############################################
    ...
    public function saveAction()
    {
        ...
        if ($data['sale_price_start_date'] === '') {
            $data['sale_price_start_date'] = Mage::helper('M2ePro')->getCurrentGmtDate();
        } else {
            $data['sale_price_start_date'] = Mage::helper('M2ePro')->timezoneDateToGmt($data['sale_price_start_date']);
        }
        if ($data['sale_price_end_date'] === '') {
            $data['sale_price_end_date'] = Mage::helper('M2ePro')->getCurrentGmtDate();
        } else {
            $data['sale_price_end_date'] = Mage::helper('M2ePro')->timezoneDateToGmt($data['sale_price_end_date']);
        }
