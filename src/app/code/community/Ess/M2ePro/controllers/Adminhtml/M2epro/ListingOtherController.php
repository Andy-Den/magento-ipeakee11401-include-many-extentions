...
class Ess_M2ePro_Adminhtml_M2epro_ListingOtherController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    //#############################################
    ...
    public function indexAction()
    {
        ...
        //----------------------------
        $lockItemEbay = Mage::getModel('M2ePro/Listing_Other_LockItem',array('component'=>Ess_M2ePro_Helper_Component_Ebay::NICK));

        if ($lockItemEbay->isExist() ) {
    ...
    public function prepareMoveToListingAction()
    {
        ...
        foreach ($selectedProductsParts as $selectedProductsPart) {
            ...
            $tempData = $listingOtherCollection
                ->getSelect()
                ->group(array('main_table.account_id','main_table.marketplace_id','cpe.attribute_set_id'))
                ->query()
                ->fetchAll();
        ...
        exit(json_encode(array(
            ...
            'attrSetId' => $tempData[0]['attribute_set_id']
        )));
    }
