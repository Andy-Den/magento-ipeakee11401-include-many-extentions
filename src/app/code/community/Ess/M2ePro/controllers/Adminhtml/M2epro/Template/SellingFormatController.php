...
class Ess_M2ePro_Adminhtml_M2epro_Template_SellingFormatController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    //#############################################
    ...
    public function editAction()
    {
        ...
        return $this->_redirect("*/adminhtml_{$template->getComponentMode()}_template_sellingFormat/edit", array('id'=>$id));
    }
