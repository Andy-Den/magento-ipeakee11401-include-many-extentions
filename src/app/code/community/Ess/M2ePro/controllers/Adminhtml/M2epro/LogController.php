...
class Ess_M2ePro_Adminhtml_M2epro_LogController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    //#############################################
    ...
    {
        $response = $this->loadLayout()->getLayout()->createBlock('M2ePro/adminhtml_synchronization_log_grid')->toHtml();
        $this->getResponse()->setBody($response);
    }
