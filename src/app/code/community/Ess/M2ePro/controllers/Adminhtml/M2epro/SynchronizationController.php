...
class Ess_M2ePro_Adminhtml_M2epro_SynchronizationController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    //#############################################
    ...
    {
        Mage::helper('M2ePro/Module')->getConfig()->setGroupValue('/synchronization/settings/defaults/inspector/', 'mode', (int)$this->getRequest()->getParam('inspector_mode'));
        ...
        foreach ($components as $component) {
            ...
            if ($component == Ess_M2ePro_Helper_Component_Ebay::NICK) {
                ...
                Mage::helper('M2ePro/Module')->getConfig()->setGroupValue('/ebay/synchronization/settings/templates/', 'mode', (int)$this->getRequest()->getParam('ebay_templates_mode'));
                Mage::helper('M2ePro/Module')->getConfig()->setGroupValue('/ebay/synchronization/settings/orders/', 'mode', (int)$this->getRequest()->getParam('ebay_orders_mode'));
                Mage::helper('M2ePro/Module')->getConfig()->setGroupValue('/ebay/synchronization/settings/feedbacks/', 'mode', (int)$this->getRequest()->getParam('ebay_feedbacks_mode'));
                Mage::helper('M2ePro/Module')->getConfig()->setGroupValue('/ebay/synchronization/settings/other_listings/', 'mode', (int)$this->getRequest()->getParam('ebay_other_listings_mode'));
                Mage::helper('M2ePro/Module')->getConfig()->setGroupValue('/ebay/synchronization/settings/messages/', 'mode', (int)$this->getRequest()->getParam('ebay_messages_mode'));
