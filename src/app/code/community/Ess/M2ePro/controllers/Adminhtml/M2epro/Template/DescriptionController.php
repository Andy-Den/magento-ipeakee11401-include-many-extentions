...
class Ess_M2ePro_Adminhtml_M2epro_Template_DescriptionController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    //#############################################
    ...
    public function editAction()
    {
        ...
        return $this->_redirect("*/adminhtml_{$template->getComponentMode()}_template_description/edit", array('id'=>$id));
    }
