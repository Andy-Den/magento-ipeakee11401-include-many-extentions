...
class Ess_M2ePro_Adminhtml_M2epro_Ebay_Template_GeneralController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    //#############################################
    ...
    public function editAction()
    {
        ...
        //-------------------------
        if (Mage::helper('M2ePro/Component_Ebay')->getCollection('Marketplace')->addFieldToFilter('status',1)->getSize() == 0) {
        ...
        foreach ($itemSpecifics['items'] as $specific) {
            ...
            if ($specific['value_mode'] == Ess_M2ePro_Model_Ebay_Template_General_Specific::VALUE_MODE_EBAY_RECOMMENDED) {
            ...
            if ($specific['value_mode'] == Ess_M2ePro_Model_Ebay_Template_General_Specific::VALUE_MODE_CUSTOM_ATTRIBUTE) {
    ...
    public function getMarketplaceInfoAction()
    {
        ...
        $tableDictShippingCategory = Mage::getSingleton('core/resource')->getTableName('m2epro_ebay_dictionary_shipping_category');
    ...
    public function getCategoriesTreeByCategoryIdAction()
    {
        ...
        for ($i = 1; $i < 8; $i++) {
            ...
            $category = Mage::getModel('M2ePro/Ebay_Marketplace')->loadInstance($marketplaceId)->getCategory($categoryId);
    ...
    public function saveAction()
    {
        ...
        $data['get_it_fast'] = isset($post['get_it_fast']) ? $post['get_it_fast'] : Ess_M2ePro_Model_Ebay_Template_General::GET_IT_FAST_DISABLED;
        ...
        $data['local_shipping_cash_on_delivery_cost_mode'] = isset($post['local_shipping_cash_on_delivery_cost_mode']) ? $post['local_shipping_cash_on_delivery_cost_mode'] : Ess_M2ePro_Model_Ebay_Template_General::CASH_ON_DELIVERY_COST_MODE_NONE;
        ...
        $data['international_shipping_mode'] = isset($post['international_shipping_mode']) ? $post['international_shipping_mode'] : Ess_M2ePro_Model_Ebay_Template_General::SHIPPING_TYPE_NO_INTERNATIONAL;
        ...
        $shippings && $connWrite->insertMultiple($coreRes->getTableName('M2ePro/Ebay_Template_General_Shipping'), $shippings);
        ...
        $payments && $connWrite->insertMultiple($coreRes->getTableName('M2ePro/Ebay_Template_General_Payment'), $payments);
        //--------------------
