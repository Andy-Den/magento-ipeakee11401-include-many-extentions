...
class Ess_M2ePro_Adminhtml_M2epro_LicenseController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    //#############################################
    ...
    public function confirmKeyAction()
    {
        if ($this->getRequest()->isPost()) {
            ...
            //Mage::helper('M2ePro/Module')->xfabricUpdateTenantDataAtServer(true);
