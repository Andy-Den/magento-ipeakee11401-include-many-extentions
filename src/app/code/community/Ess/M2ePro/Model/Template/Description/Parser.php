...
class Ess_M2ePro_Model_Template_Description_Parser
{
    ...
    private function insertImages($text, Ess_M2ePro_Model_Magento_Product $magentoProduct)
    {
        ...
        $blockObj = Mage::getSingleton('core/layout')->createBlock('M2ePro/adminhtml_template_description_template_image');
    ...
    private function insertMediaGalleries($text, Ess_M2ePro_Model_Magento_Product $magentoProduct)
    {
        ...
        $blockObj = Mage::getSingleton('core/layout')->createBlock('M2ePro/adminhtml_template_description_template_gallery');
