...
abstract class Ess_M2ePro_Model_Synchronization_Dispatcher_Abstract
{
    ...
    protected function catchException($exception)
    {
        ...
        Mage::helper('M2ePro')->getGlobalValue('synchLogs')->addMessage(Mage::helper('M2ePro')->__($exception->getMessage()),
                                                Ess_M2ePro_Model_Log_Abstract::TYPE_ERROR,
                                                Ess_M2ePro_Model_Log_Abstract::PRIORITY_HIGH);

        Mage::helper('M2ePro')->getGlobalValue('synchProfiler')->addTitle(Mage::helper('M2ePro')->__($exception->getMessage()),
