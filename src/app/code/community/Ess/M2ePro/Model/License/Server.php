    ...
    public function updateStatus($forceUpdate = false)
    {
        ...
        foreach (Mage::helper('M2ePro/Component')->getComponents() as $component) {
            ...
            if (isset($data['components'][$component]['status'])) {
                ...
                Mage::getModel('M2ePro/License_Model')->setStatus($component,Ess_M2ePro_Model_License_Model::STATUS_NONE);
            }

            if (isset($data['components'][$component]['expiration_date'])) {
                Mage::getModel('M2ePro/License_Model')->setExpirationDate($component,$data['components'][$component]['expiration_date']);
            } else {
