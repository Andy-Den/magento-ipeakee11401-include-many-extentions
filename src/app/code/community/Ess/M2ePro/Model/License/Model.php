...
class Ess_M2ePro_Model_License_Model extends Ess_M2ePro_Model_Abstract
{
    ...
    {
        $mode = Mage::helper('M2ePro/Ess')->getConfig()->getGroupValue('/'.Mage::helper('M2ePro/Module')->getName().'/license/'.strtolower($component).'/','mode');
    ...
    public function setMode($component,$mode)
    {
        ...
        Mage::helper('M2ePro/Ess')->getConfig()->setGroupValue('/'.Mage::helper('M2ePro/Module')->getName().'/license/'.strtolower($component).'/','mode',$mode);
        return true;
    }
    ...
    public function setModeDefault($component,$forceSet = false)
    {
        ...
        if (is_null($mode) || $forceSet) {
            Mage::helper('M2ePro/Ess')->getConfig()->setGroupValue('/'.Mage::helper('M2ePro/Module')->getName().'/license/'.strtolower($component).'/','mode',self::MODE_NONE);
        }
    }
    ...
    {
        $status = Mage::helper('M2ePro/Ess')->getConfig()->getGroupValue('/'.Mage::helper('M2ePro/Module')->getName().'/license/'.strtolower($component).'/','status');
    ...
    public function setStatus($component,$status)
    {
        ...
        Mage::helper('M2ePro/Ess')->getConfig()->setGroupValue('/'.Mage::helper('M2ePro/Module')->getName().'/license/'.strtolower($component).'/','status',$status);
        return true;
    }
    ...
    public function setStatusDefault($component,$forceSet = false)
    {
        ...
        if (is_null($status) || $forceSet) {
            Mage::helper('M2ePro/Ess')->getConfig()->setGroupValue('/'.Mage::helper('M2ePro/Module')->getName().'/license/'.strtolower($component).'/','status',self::STATUS_NONE);
        }
    }
    ...
    {
        $date = Mage::helper('M2ePro/Ess')->getConfig()->getGroupValue('/'.Mage::helper('M2ePro/Module')->getName().'/license/'.strtolower($component).'/','expiration_date');
    ...
    {
        if ($withTime) {
            return Mage::helper('M2ePro')->gmtDateToTimezone($this->getTimeStampExpirationDate($component));
        } else {
            return Mage::helper('M2ePro')->gmtDateToTimezone($this->getTimeStampExpirationDate($component),false,'Y-m-d');
        }
    }
    ...
    {
        Mage::helper('M2ePro/Ess')->getConfig()->setGroupValue('/'.Mage::helper('M2ePro/Module')->getName().'/license/'.strtolower($component).'/','expiration_date',(string)$date);
    }
    ...
    public function setExpirationDateDefault($component,$forceSet = false)
    {
        ...
        if (is_null($date) || $forceSet) {
            Mage::helper('M2ePro/Ess')->getConfig()->setGroupValue('/'.Mage::helper('M2ePro/Module')->getName().'/license/'.strtolower($component).'/','expiration_date','');
        }
    }
