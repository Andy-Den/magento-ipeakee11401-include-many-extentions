...
class Ess_M2ePro_Model_Ebay_Synchronization_Tasks_Feedbacks_Receive extends Ess_M2ePro_Model_Ebay_Synchronization_Tasks
{
    ...
    private function execute()
    {
        ...
        $accountsCollection->addFieldToFilter('feedbacks_receive', Ess_M2ePro_Model_Ebay_Account::FEEDBACKS_RECEIVE_YES);
        ...
        foreach ($accounts as $account) {
            ...
            $tempString = str_replace('%acc%',$account->getTitle(),Mage::helper('M2ePro')->__('The "Receive" action for eBay account: "%acc%" is started. Please wait...'));
