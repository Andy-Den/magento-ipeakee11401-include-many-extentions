...
class Ess_M2ePro_Model_Ebay_Synchronization_Tasks_Templates extends Ess_M2ePro_Model_Ebay_Synchronization_Tasks
{
    ...
    public function process()
    {
        ...
        //-----------------------------
        $startMode = (bool)(int)Mage::helper('M2ePro/Module')->getConfig()->getGroupValue('/ebay/synchronization/settings/templates/start/','mode');
        $endMode = (bool)(int)Mage::helper('M2ePro/Module')->getConfig()->getGroupValue('/ebay/synchronization/settings/templates/end/','mode');
        $reviseMode = (bool)(int)Mage::helper('M2ePro/Module')->getConfig()->getGroupValue('/ebay/synchronization/settings/templates/revise/','mode');
        $relistMode = (bool)(int)Mage::helper('M2ePro/Module')->getConfig()->getGroupValue('/ebay/synchronization/settings/templates/relist/','mode');
        $stopMode = (bool)(int)Mage::helper('M2ePro/Module')->getConfig()->getGroupValue('/ebay/synchronization/settings/templates/stop/','mode');
