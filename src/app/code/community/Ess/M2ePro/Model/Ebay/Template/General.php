...
class Ess_M2ePro_Model_Ebay_Template_General extends Ess_M2ePro_Model_Component_Child_Ebay_Abstract
{
    ...
    public function getCalculatedShipping()
    {
        if (is_null($this->calculatedShippingModel)) {
            $calculatedShippingObject = Mage::getModel('M2ePro/Ebay_Template_General_CalculatedShipping')->load($this->getId());
    ...
    {
        return $this->getRelatedSimpleItems('Ebay_Template_General_Shipping','template_general_id',$asObjects,$filters,$sort);
    }
