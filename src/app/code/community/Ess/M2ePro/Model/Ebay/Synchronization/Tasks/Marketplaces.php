...
class Ess_M2ePro_Model_Ebay_Synchronization_Tasks_Marketplaces extends Ess_M2ePro_Model_Ebay_Synchronization_Tasks
{
    ...
    public function process()
    {
        ...
        //-----------------------------
        $detailsMode = (bool)(int)Mage::helper('M2ePro/Module')->getConfig()->getGroupValue('/ebay/synchronization/settings/marketplaces/details/','mode');
        $categoriesMode = (bool)(int)Mage::helper('M2ePro/Module')->getConfig()->getGroupValue('/ebay/synchronization/settings/marketplaces/categories/','mode');
