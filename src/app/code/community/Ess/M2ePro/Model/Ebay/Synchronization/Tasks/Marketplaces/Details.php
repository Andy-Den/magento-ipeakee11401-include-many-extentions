...
class Ess_M2ePro_Model_Ebay_Synchronization_Tasks_Marketplaces_Details extends Ess_M2ePro_Model_Ebay_Synchronization_Tasks
{
    ...
    private function execute()
    {
        if (!empty($this->_params['marketplace_id'])) {
            $markeptlaceObj = Mage::helper('M2ePro/Component')->getUnknownObject('Marketplace',$this->_params['marketplace_id']);
        ...
        $tableShippingsCategories = Mage::getSingleton('core/resource')->getTableName('m2epro_ebay_dictionary_shipping_category');
        //-----------------------
