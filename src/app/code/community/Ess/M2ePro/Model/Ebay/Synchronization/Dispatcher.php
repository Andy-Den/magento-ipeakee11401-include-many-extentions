...
class Ess_M2ePro_Model_Ebay_Synchronization_Dispatcher extends Ess_M2ePro_Model_Synchronization_Dispatcher_Abstract
{
    ...
    public function process()
    {
        // Check global mode
        //----------------------------------
        if (!(bool)Mage::helper('M2ePro/Module')->getConfig()->getGroupValue('/ebay/synchronization/settings/','mode')) {
            return false;
        }
        //----------------------------------
        ...
        try {
            ...
            $tempLocalMode = (bool)(int)Mage::helper('M2ePro/Module')->getConfig()->getGroupValue('/ebay/synchronization/settings/defaults/','mode');
        ...
        try {
            ...
            $tempLocalMode = (bool)(int)Mage::helper('M2ePro/Module')->getConfig()->getGroupValue('/ebay/synchronization/settings/orders/','mode');
            if ($tempTask && $tempGlobalMode && $tempLocalMode) {
        ...
        try {
            ...
            $tempLocalMode = (bool)(int)Mage::helper('M2ePro/Module')->getConfig()->getGroupValue('/ebay/synchronization/settings/templates/','mode');
            if ($tempTask && $tempGlobalMode && $tempLocalMode) {
        ...
        try {
            ...
            $tempGlobalMode = (bool)(int)Mage::helper('M2ePro/Module')->getConfig()->getGroupValue('/synchronization/settings/feedbacks/','mode');
            $tempLocalMode = (bool)(int)Mage::helper('M2ePro/Module')->getConfig()->getGroupValue('/ebay/synchronization/settings/feedbacks/','mode');
            if ($tempTask && $tempGlobalMode && $tempLocalMode) {
        ...
        try {
            ...
            $tempGlobalMode = (bool)(int)Mage::helper('M2ePro/Module')->getConfig()->getGroupValue('/synchronization/settings/messages/','mode');
            $tempLocalMode = (bool)(int)Mage::helper('M2ePro/Module')->getConfig()->getGroupValue('/ebay/synchronization/settings/messages/','mode');
            if ($tempTask && $tempGlobalMode && $tempLocalMode) {
        ...
        try {
            ...
            $tempLocalMode = (bool)(int)Mage::helper('M2ePro/Module')->getConfig()->getGroupValue('/ebay/synchronization/settings/marketplaces/','mode');
            if ($tempTask && $tempGlobalMode && $tempLocalMode) {
        ...
        try {
            ...
            $tempLocalMode = (bool)(int)Mage::helper('M2ePro/Module')->getConfig()->getGroupValue('/ebay/synchronization/settings/other_listings/','mode');
            if ($tempTask && $tempGlobalMode && $tempLocalMode) {
