...
class Ess_M2ePro_Model_Ebay_Synchronization_Tasks_Feedbacks extends Ess_M2ePro_Model_Ebay_Synchronization_Tasks
{
    ...
    public function process()
    {
        ...
        //-----------------------------
        $receiveMode = (bool)(int)Mage::helper('M2ePro/Module')->getConfig()->getGroupValue('/ebay/synchronization/settings/feedbacks/receive/','mode');
        $responseMode = (bool)(int)Mage::helper('M2ePro/Module')->getConfig()->getGroupValue('/ebay/synchronization/settings/feedbacks/response/','mode');
