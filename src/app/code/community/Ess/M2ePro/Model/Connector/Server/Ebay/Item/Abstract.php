...
abstract class Ess_M2ePro_Model_Connector_Server_Ebay_Item_Abstract extends Ess_M2ePro_Model_Connector_Server_Ebay_Abstract
{
    ...
    protected function addListingsLogsMessage(array $message, $priority = Ess_M2ePro_Model_Log_Abstract::PRIORITY_MEDIUM)
    {
