    ...
    public function process($action, $products, array $params = array())
    {
        ...
        switch ($action) {
            case self::ACTION_LIST:
                $result = $this->processListings($listings, 5, 'Ess_M2ePro_Model_Connector_Server_Ebay_Item_List_Single', 'Ess_M2ePro_Model_Connector_Server_Ebay_Item_List_Multiple', $params);
                break;

            case self::ACTION_RELIST:
                $result = $this->processListings($listings, NULL, 'Ess_M2ePro_Model_Connector_Server_Ebay_Item_Relist_Single', NULL, $params);
                break;

            case self::ACTION_REVISE:
                $result = $this->processListings($listings, NULL, 'Ess_M2ePro_Model_Connector_Server_Ebay_Item_Revise_Single', NULL, $params);
                break;

            case self::ACTION_STOP:
                $result = $this->processListings($listings, 10, 'Ess_M2ePro_Model_Connector_Server_Ebay_Item_Stop_Single', 'Ess_M2ePro_Model_Connector_Server_Ebay_Item_Stop_Multiple', $params);
                break;
