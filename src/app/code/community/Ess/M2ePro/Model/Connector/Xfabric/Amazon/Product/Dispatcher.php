...
class Ess_M2ePro_Model_Connector_Xfabric_Amazon_Product_Dispatcher
{
    const ACTION_LIST    = 1;
    ...
    {
        $result = Ess_M2ePro_Model_Connector_Xfabric_Amazon_Product_Requester::STATUS_ERROR;
        ...
        switch ($action) {
            case self::ACTION_LIST:
                $result = $this->processGropedProducts($sortedProductsData, 1000, 'Ess_M2ePro_Model_Connector_Xfabric_Amazon_Product_List_Multiple', $params);
                break;

            case self::ACTION_RELIST:
                $result = $this->processGropedProducts($sortedProductsData, 1000, 'Ess_M2ePro_Model_Connector_Xfabric_Amazon_Product_Relist_Multiple', $params);
                break;

            case self::ACTION_REVISE:
                $result = $this->processGropedProducts($sortedProductsData, 1000, 'Ess_M2ePro_Model_Connector_Xfabric_Amazon_Product_Revise_Multiple', $params);
                break;

            case self::ACTION_STOP:
                $result = $this->processGropedProducts($sortedProductsData, 1000, 'Ess_M2ePro_Model_Connector_Xfabric_Amazon_Product_Stop_Multiple', $params);
                break;
     ...
     * @return int
     */
    protected function processGropedProducts(array $sortedProductsData, $maxProductsForOneRequest, $connectorName, array $params = array())
    {
        $results = array();
    ...
    protected function processProducts(array $products, $connectorName, array $params = array())
    {
        try {
            ...
            return Ess_M2ePro_Model_Connector_Xfabric_Amazon_Product_Requester::STATUS_ERROR;
        }
    }
