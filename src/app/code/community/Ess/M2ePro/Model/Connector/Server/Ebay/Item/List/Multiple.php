...
class Ess_M2ePro_Model_Connector_Server_Ebay_Item_List_Multiple extends Ess_M2ePro_Model_Connector_Server_Ebay_Item_MultipleAbstract
{
    // ########################################
    ...
    protected function getRequestData()
    {
        ...
        foreach ($this->listingsProducts as $listingProduct) {
            ...
            if ($listingProduct->isListable()) {
                ...
                $requestData['products'][$listingProduct->getId()] = Mage::getModel('M2ePro/Connector_Server_Ebay_Item_Helper')
            ...
            foreach ($response['result'] as $tempIdProduct=>$tempResultProduct) {
                ...
                if ($resultSuccess) {
                    ...
                    Mage::getModel('M2ePro/Connector_Server_Ebay_Item_Helper')
                                ->updateAfterListAction($listingProductInArray, $this->nativeRequestData['products'][$listingProductInArray->getId()],
