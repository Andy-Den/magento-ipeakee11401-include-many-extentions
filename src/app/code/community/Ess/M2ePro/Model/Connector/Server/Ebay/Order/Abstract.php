...
abstract class Ess_M2ePro_Model_Connector_Server_Ebay_Order_Abstract extends Ess_M2ePro_Model_Connector_Server_Ebay_Abstract
{
    ...
    {
        if (!in_array($this->action, array(Ess_M2ePro_Model_Connector_Server_Ebay_Order_Dispatcher::ACTION_PAY,
