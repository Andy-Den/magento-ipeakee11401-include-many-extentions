...
abstract class Ess_M2ePro_Model_Connector_Server_Ebay_OtherItem_Abstract extends Ess_M2ePro_Model_Connector_Server_Ebay_Abstract
{
    /**
    ...
    protected function addProductsLogsMessage(Ess_M2ePro_Model_Listing_Other $otherListing,
                                              array $message, $priority = Ess_M2ePro_Model_Log_Abstract::PRIORITY_MEDIUM)
    {
    ...
    private function addBaseLogsMessage($otherListing, array $message, $priority = Ess_M2ePro_Model_Log_Abstract::PRIORITY_MEDIUM)
    {
