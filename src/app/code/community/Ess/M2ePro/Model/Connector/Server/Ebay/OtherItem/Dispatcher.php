    ...
    public function process($action, $products, array $params = array())
    {
        ...
        switch ($action) {
            case Ess_M2ePro_Model_Connector_Server_Ebay_Item_Dispatcher::ACTION_RELIST:
                $result = $this->processProducts($products, 'Ess_M2ePro_Model_Connector_Server_Ebay_OtherItem_Relist_Single', $params);
                break;

            case Ess_M2ePro_Model_Connector_Server_Ebay_Item_Dispatcher::ACTION_STOP:
                $result = $this->processProducts($products, 'Ess_M2ePro_Model_Connector_Server_Ebay_OtherItem_Stop_Single', $params);
                break;
