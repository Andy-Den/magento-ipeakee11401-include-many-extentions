...
class Ess_M2ePro_Model_Connector_Xfabric_Amazon_Product_Relist_MultipleResponser extends Ess_M2ePro_Model_Connector_Xfabric_Amazon_Product_Responser
{
    // ########################################
    ...
    protected function processSucceededListingsProducts(array $listingsProducts = array())
    {
        foreach ($listingsProducts as $listingProduct) {
            ...
            Mage::getModel('M2ePro/Connector_Xfabric_Amazon_Product_Helper')
                        ->updateAfterRelistAction($listingProduct,$tempParams);
