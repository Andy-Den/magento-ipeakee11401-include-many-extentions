...
class Ess_M2ePro_Model_Amazon_Synchronization_Tasks_Templates_Start extends Ess_M2ePro_Model_Amazon_Synchronization_Tasks
{
    ...
    private function executeListAllStoppedItems()
    {
        ...
        foreach ($this->_synchronizations as &$synchronization) {
            ...
            foreach ($synchronization['listings'] as &$listing) {
                ...
                $listingsProducts = $listing->getProducts(true,array('status'=>array('nin'=>array(Ess_M2ePro_Model_Listing_Product::STATUS_LISTED))));
