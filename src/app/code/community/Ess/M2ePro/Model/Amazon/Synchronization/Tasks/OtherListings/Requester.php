...
class Ess_M2ePro_Model_Amazon_Synchronization_Tasks_OtherListings_Requester extends Ess_M2ePro_Model_Connector_Xfabric_Amazon_Inventory_Get_Items
{
    // ########################################

    protected function makeResponserModel()
    {
        return 'M2ePro/Amazon_Synchronization_Tasks_OtherListings_Responser';
    }
    ...
    protected function setLocks($messageHash)
    {
        ...
        $this->account->addObjectLock(Ess_M2ePro_Model_Amazon_Synchronization_Tasks_OtherListings::LOCK_ITEM_PREFIX,$messageHash);
        ...
        $this->marketplace->addObjectLock(Ess_M2ePro_Model_Amazon_Synchronization_Tasks_OtherListings::LOCK_ITEM_PREFIX,$messageHash);
    }
