...
class Ess_M2ePro_Model_Migration
{
    ...
    /** @var Ess_M2ePro_Model_MySqlSetup */
    ...
    public function setInstaller(Ess_M2ePro_Model_MySqlSetup $installer)
    {
    ...
    public function migrate()
    {
        ...
        !$this->checkToSkipStep('m2epro'.$this->prefixTo.'_xfabric_schema') &&
...
SQL
        ...
        $tempTable = $this->installer->getTable('m2epro'.$this->prefixTo.'_xfabric_request');
...
SQL
        ...
        $tempTable = $this->installer->getTable('m2epro'.$this->prefixTo.'_xfabric_schema');
...
INSERT INTO `{$newTable}` (`group`,`key`,`value`,`notice`,`update_date`,`create_date`) VALUES
    ...
    ('/M2ePro/xfabric/', 'tenant_token', NULL, 'Capability tenant token', '2012-05-25 07:52:28', '2012-05-21 10:47:49'),
    ('/M2ePro/xfabric/', 'fabric_token', NULL, 'Capability fabric token', '2012-05-25 07:52:28', '2012-05-21 10:47:49'),
    ('/M2ePro/xfabric/', 'tenant_id', NULL, 'Capability tenant id', '2012-05-25 07:52:28', '2012-05-21 10:47:49'),
    ('/M2ePro/xfabric/', 'capability_token', NULL, 'Capability token', '2012-05-25 07:52:28', '2012-05-21 10:47:49'),
    ('/M2ePro/xfabric/amazon/', 'destination_id', NULL, 'Server destination id', '2012-05-25 07:52:28', '2012-05-21 10:47:49'),
    ('/M2ePro/xfabric/amazon/', 'tenant_id', NULL, 'Server tenant id', '2012-05-25 07:52:28', '2012-05-21 10:47:49'),
    ('/xfabric/', 'endpoint', 'https://api.x.com/fabric/', 'Xfabric endpoint url', '2012-05-25 07:52:28', '2012-05-21 10:47:49');
...
INSERT INTO `{$newTable}` (`group`,`key`,`value`,`notice`,`update_date`,`create_date`) VALUES
    ...
    ('/synchronization/settings/defaults/inspector/', 'last_listing_product_id', NULL, NULL, '2012-06-01 11:48:49', '2012-05-21 10:47:49'),
    ('/synchronization/settings/defaults/inspector/', 'min_interval_between_circles', '3600', 'in seconds', '2012-06-01 11:48:49', '2012-06-01 11:48:49'),
    ('/synchronization/settings/defaults/inspector/', 'max_count_times_for_full_circle', '50', NULL, '2012-06-01 11:48:49', '2012-06-01 11:48:49'),
    ('/synchronization/settings/defaults/inspector/', 'min_count_items_per_one_time', '100', NULL, '2012-06-01 11:48:49', '2012-06-01 11:48:49'),
    ('/synchronization/settings/defaults/inspector/', 'max_count_items_per_one_time', '1000', NULL, '2012-06-01 11:48:49', '2012-06-01 11:48:49'),
    ('/synchronization/settings/defaults/inspector/', 'last_time_start_circle', NULL, NULL, '2012-06-01 11:48:49', '2012-06-01 11:48:49'),
    ...
    ('/cron/task/synchronization/', 'last_access', NULL, 'date of last access', '2012-05-21 10:47:49', '2012-05-21 10:47:49'),
    ('/cron/task/synchronization/', 'interval', '300', 'in seconds', '2012-05-21 10:47:49', '2012-05-21 10:47:49'),
    ('/cron/task/xfabric/', 'mode', '1', '0 - disable, \r\n1 - enable', '2012-05-21 10:47:49', '2012-05-21 10:47:49'),
    ('/cron/task/xfabric/', 'last_access', NULL, 'date of last access', '2012-05-21 10:47:49', '2012-05-21 10:47:49'),
    ('/cron/task/xfabric/', 'interval', '3600', 'in seconds', '2012-05-21 10:47:49', '2012-05-21 10:47:49'),
    ('/cron/task/logs_cleaning/', 'mode', '1', '0 - disable, \r\n1 - enable', '2012-05-21 10:47:49', '2012-05-21 10:47:49'),
    ('/cron/task/logs_cleaning/', 'last_access', NULL, 'date of last access', '2012-05-21 10:47:49', '2012-05-21 10:47:49'),
...
SQL
        ...
        $this->installer->getConnection()->update($newGeneralTable, array('native_id' => new Zend_Db_Expr("`id`")));
        $this->installer->getConnection()->update($newGeneralTable, array('id' => new Zend_Db_Expr("`id` + {$this->marketplaceIdTempShift}")));
        foreach ($this->marketplacesConverter as $oldId => $newId) {
            $this->installer->getConnection()->update($newGeneralTable, array('id' => $newId), array('id = ?'=>$oldId+$this->marketplaceIdTempShift));
        }
        $this->installer->getConnection()->modifyColumn($newGeneralTable, 'id', 'INT(11) UNSIGNED NOT NULL AUTO_INCREMENT');
        $this->installer->getConnection()->dropColumn($newGeneralTable,'categories_version');
        $this->installer->getConnection()->addColumn($newGeneralTable,'component_mode','VARCHAR(10) DEFAULT NULL AFTER group_title');
        $this->installer->getConnection()->update($newGeneralTable, array('component_mode' => Ess_M2ePro_Helper_Component_Ebay::NICK));
        ...
        $this->installer->getConnection()->update($newComponentTable, array('marketplace_id' => new Zend_Db_Expr("`marketplace_id` + {$this->marketplaceIdTempShift}")));
        foreach ($this->marketplacesConverter as $oldId => $newId) {
            $this->installer->getConnection()->update($newComponentTable, array('marketplace_id' => $newId), array('marketplace_id = ?'=>$oldId+$this->marketplaceIdTempShift));
            if (in_array($newId,$this->marketplacesWithMultivariation)) {
                $this->installer->getConnection()->update($newComponentTable, array('is_multivariation' => 1), array('marketplace_id = ?'=>$newId));
            }
        }
    }
    ...
    private function processM2eProAccountsTable()
    {
        ...
        $tempStmt = $this->installer->getConnection()
                              ->query("SELECT *
                                       FROM `{$configTable}`
                                       WHERE `group` = '/ebay/synchronization/settings/orders/'
                                       AND `key` = 'since_time'");
        ...
        $tempComponentNick = Ess_M2ePro_Helper_Component_Ebay::NICK;
...
SET `magento_orders_settings` = '{$convertedSettings}'
...
SQL
        ...
        $this->installer->getConnection()->update($newGeneralTable, array('object_type' => new Zend_Db_Expr("`object_type` + 5")));
        $this->installer->getConnection()->update($newGeneralTable, array('object_type' => Ess_M2ePro_Model_AttributeSet::OBJECT_TYPE_TEMPLATE_SELLING_FORMAT), array('`object_type` = ?'=>1+5));
        $this->installer->getConnection()->update($newGeneralTable, array('object_type' => Ess_M2ePro_Model_AttributeSet::OBJECT_TYPE_TEMPLATE_DESCRIPTION), array('`object_type` = ?'=>2+5));
        $this->installer->getConnection()->update($newGeneralTable, array('object_type' => Ess_M2ePro_Model_AttributeSet::OBJECT_TYPE_TEMPLATE_GENERAL), array('`object_type` = ?'=>3+5));
    }
...
SQL
        ...
        $this->installer->getConnection()->changeColumn($newComponentTable, 'id', 'template_selling_format_id', 'INT(11) UNSIGNED NOT NULL');
        ...
        $this->installer->getConnection()->changeColumn($newComponentTable, 'duration_ebay', 'duration_mode', 'TINYINT(4) UNSIGNED NOT NULL');
...
SQL
        ...
        $this->installer->getConnection()->changeColumn($newComponentTable, 'id', 'template_description_id', 'INT(11) UNSIGNED NOT NULL');
...
SQL
        ...
        $this->installer->getConnection()->changeColumn($newComponentTable, 'id', 'template_synchronization_id', 'INT(11) UNSIGNED NOT NULL');

        $this->installer->getConnection()->addColumn($newComponentTable, 'revise_update_ebay_qty', 'TINYINT(2) UNSIGNED NOT NULL');
        $this->installer->getConnection()->changeColumn($newComponentTable, 'revise_update_ebay_qty', 'revise_update_qty', 'TINYINT(2) UNSIGNED NOT NULL');
        $this->installer->getConnection()->changeColumn($newComponentTable, 'revise_update_ebay_price', 'revise_update_price', 'TINYINT(2) UNSIGNED NOT NULL');
        ...
        $this->installer->getConnection()->addKey($newComponentTable, 'revise_update_price', 'revise_update_price', 'index');
        $this->installer->getConnection()->addKey($newComponentTable, 'revise_update_qty', 'revise_update_qty', 'index');
...
SQL
        ...
        $this->installer->getConnection()->update($newGeneralTable, array('marketplace_id' => new Zend_Db_Expr("`marketplace_id` + {$this->marketplaceIdTempShift}")));
        foreach ($this->marketplacesConverter as $oldId => $newId) {
            $this->installer->getConnection()->update($newGeneralTable, array('marketplace_id' => $newId), array('marketplace_id = ?'=>$oldId+$this->marketplaceIdTempShift));
        }

        // Component table

        $this->installer->getConnection()->changeColumn($newComponentTable, 'id', 'template_general_id', 'INT(11) UNSIGNED NOT NULL');
    ...
    {
        $oldTable = $this->installer->getTable('m2epro'.self::PREFIX_TABLE_BACKUP.'_listings_templates_calculated_shipping');
        $newComponentTable = $this->installer->getTable('m2epro'.$this->prefixTo.'_ebay_template_general_calculated_shipping');
...
SQL
        ...
        $this->installer->getConnection()->changeColumn($newComponentTable, 'listing_template_id', 'template_general_id', 'INT(11) UNSIGNED NOT NULL');
    }
...
SQL
    ...
    private function processM2eProListingsTable()
    {
        ...
        $tempObjectType = Ess_M2ePro_Model_AttributeSet::OBJECT_TYPE_LISTING;
...
SQL
        ...
        $this->installer->getConnection()->changeColumn($newGeneralTable, 'selling_format_template_id', 'template_selling_format_id', 'INT(11) UNSIGNED NOT NULL');
        $this->installer->getConnection()->changeColumn($newGeneralTable, 'listing_template_id', 'template_general_id', 'INT(11) UNSIGNED NOT NULL');
        $this->installer->getConnection()->changeColumn($newGeneralTable, 'description_template_id', 'template_description_id', 'INT(11) UNSIGNED NOT NULL');
        $this->installer->getConnection()->changeColumn($newGeneralTable, 'synchronization_template_id', 'template_synchronization_id', 'INT(11) UNSIGNED NOT NULL');
        ...
        $this->installer->getConnection()->addColumn($newGeneralTable,'component_mode','VARCHAR(10) DEFAULT NULL AFTER hide_products_others_listings');
        $this->installer->getConnection()->update($newGeneralTable, array('component_mode' => Ess_M2ePro_Helper_Component_Ebay::NICK));
        $this->installer->getConnection()->addKey($newGeneralTable, 'component_mode', 'component_mode', 'index');
        ...
        $this->installer->getConnection()->addKey($newGeneralTable, 'template_general_id', 'template_general_id', 'index');
        $this->installer->getConnection()->addKey($newGeneralTable, 'template_selling_format_id', 'template_selling_format_id', 'index');
        $this->installer->getConnection()->addKey($newGeneralTable, 'template_description_id', 'template_description_id', 'index');
        $this->installer->getConnection()->addKey($newGeneralTable, 'template_synchronization_id', 'template_synchronization_id', 'index');
    }
...
SQL
    ...
    {
        $oldTable = $this->installer->getTable('m2epro'.self::PREFIX_TABLE_BACKUP.'_listings_products_variations_options');
        $newGeneralTable = $this->installer->getTable('m2epro'.$this->prefixTo.'_listing_product_variation_option');
        $newComponentTable = $this->installer->getTable('m2epro'.$this->prefixTo.'_ebay_listing_product_variation_option');
...
SQL
        ...
        $this->installer->getConnection()->modifyColumn($newGeneralTable, 'action_id', 'INT(11) UNSIGNED DEFAULT NULL AFTER product_title');
        $this->installer->getConnection()->addColumn($newGeneralTable,'component_mode','VARCHAR(10) DEFAULT NULL AFTER description');
        $this->installer->getConnection()->addColumn($newGeneralTable,'action','TINYINT(2) UNSIGNED NOT NULL DEFAULT 1 AFTER action_id');
        $this->installer->getConnection()->update($newGeneralTable, array('component_mode' => Ess_M2ePro_Helper_Component_Ebay::NICK));
        $this->installer->getConnection()->modifyColumn($newGeneralTable, 'action', 'TINYINT(2) UNSIGNED NOT NULL DEFAULT 1 AFTER action_id');
        $this->installer->getConnection()->modifyColumn($newGeneralTable, 'initiator', 'TINYINT(2) UNSIGNED NOT NULL DEFAULT 0 AFTER action');
...
SQL
        ...
        $this->installer->getConnection()->changeColumn($newGeneralTable, 'synchronizations_runs_id', 'synchronization_run_id', 'INT(11) UNSIGNED NOT NULL');
        $this->installer->getConnection()->addColumn($newGeneralTable,'initiator','TINYINT(2) UNSIGNED NOT NULL DEFAULT 0 AFTER synch_task');
        $this->installer->getConnection()->addColumn($newGeneralTable,'component_mode','VARCHAR(10) DEFAULT NULL AFTER description');
        $this->installer->getConnection()->update($newGeneralTable, array('component_mode' => Ess_M2ePro_Helper_Component_Ebay::NICK));
        $this->installer->getConnection()->modifyColumn($newGeneralTable, 'creator', 'VARCHAR(255) DEFAULT NULL');
        $this->installer->getConnection()->modifyColumn($newGeneralTable, 'creator', 'VARCHAR(255) DEFAULT NULL');
        $this->installer->getConnection()->modifyColumn($newGeneralTable, 'type', 'TINYINT(2) UNSIGNED NOT NULL DEFAULT 1');
        $this->installer->getConnection()->modifyColumn($newGeneralTable, 'priority', 'TINYINT(2) UNSIGNED NOT NULL DEFAULT 3');
        $this->installer->getConnection()->addKey($newGeneralTable, 'component_mode', 'component_mode', 'index');
        $this->installer->getConnection()->addKey($newGeneralTable, 'initiator', 'initiator', 'index');
        $this->installer->getConnection()->dropKey($newGeneralTable,'synchronizations_runs_id');
        $this->installer->getConnection()->addKey($newGeneralTable, 'synchronization_run_id', 'synchronization_run_id', 'index');
    }
...
SQL
        ...
        $this->installer->getConnection()->changeColumn($newGeneralTable, 'ebay_listing_id', 'listing_other_id', 'INT(11) UNSIGNED DEFAULT NULL');
        $this->installer->getConnection()->modifyColumn($newGeneralTable, 'title', 'VARCHAR(255) DEFAULT NULL AFTER listing_other_id');
        $this->installer->getConnection()->modifyColumn($newGeneralTable, 'action', 'TINYINT(2) UNSIGNED NOT NULL DEFAULT 1 AFTER action_id');
        $this->installer->getConnection()->modifyColumn($newGeneralTable, 'initiator', 'TINYINT(2) UNSIGNED NOT NULL DEFAULT 0 AFTER action');
        $this->installer->getConnection()->addColumn($newGeneralTable,'component_mode','VARCHAR(10) DEFAULT NULL AFTER description');
        $this->installer->getConnection()->update($newGeneralTable, array('component_mode' => Ess_M2ePro_Helper_Component_Ebay::NICK));
        ...
        $this->installer->getConnection()->addKey($newGeneralTable, 'listing_other_id', 'listing_other_id', 'index');
    }
...
SQL
    ...
    private function checkToSkipStep($nextTable)
    {
        ...
        $isExistNextTable = $this->installer->tableExists($nextTable);
    ...
    private function convertMagentoOrdersSettings(array $singleAccountSettings)
    {
        $newFormat = array(
            ...
            'status_mapping' => array(
                ...
                'new' => !empty($singleAccountSettings['orders_status_checkout_completed']) ? $singleAccountSettings['orders_status_checkout_completed']
                                                                                            : Ess_M2ePro_Model_Ebay_Account::MAGENTO_ORDERS_STATUS_MAPPING_NEW,
                'paid' => !empty($singleAccountSettings['orders_status_payment_completed']) ? $singleAccountSettings['orders_status_payment_completed']
                                                                                           : Ess_M2ePro_Model_Ebay_Account::MAGENTO_ORDERS_STATUS_MAPPING_PAID,
                'shipped' => !empty($singleAccountSettings['orders_status_shipping_completed']) ? $singleAccountSettings['orders_status_shipping_completed']
                                                                                           : Ess_M2ePro_Model_Ebay_Account::MAGENTO_ORDERS_STATUS_MAPPING_SHIPPED,
            ),
