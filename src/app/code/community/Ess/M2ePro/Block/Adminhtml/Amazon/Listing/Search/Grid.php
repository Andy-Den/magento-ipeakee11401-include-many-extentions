...
class Ess_M2ePro_Block_Adminhtml_Amazon_Listing_Search_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->join(array('l'=>Mage::getResourceModel('M2ePro/Listing')->getMainTable()), '(`l`.`id` = `main_table`.`listing_id`)', array('listing_title'=>'title','store_id','template_selling_format_id'));
        //--------------------------------
