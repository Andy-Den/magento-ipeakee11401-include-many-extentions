...
class Ess_M2ePro_Block_Adminhtml_Ebay_Template_General_Edit_Tabs_General extends Mage_Adminhtml_Block_Widget
{
    ...
    protected function generateCategories($type, $formData)
    {
        ...
        for ($i = 1; $i < 8; $i++) {
            ...
            $category = Mage::getModel('M2ePro/Ebay_Marketplace')
        ...
        foreach ($parentIds as $id) {
            $categories = Mage::getModel('M2ePro/Ebay_Marketplace')->loadInstance($formData['marketplace_id'])->getChildCategories($id);
