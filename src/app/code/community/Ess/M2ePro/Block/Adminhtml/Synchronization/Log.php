    ...
    public function __construct()
    {
        ...
        if (!is_null($this->getRequest()->getParam('back'))) {
            ...
            $this->_addButton('back', array(
                ...
                'onclick'   => 'CommonHandlerObj.back_click(\''.Mage::helper('M2ePro')->getBackUrl('*/adminhtml_synchronization/index').'\')',
                'class'     => 'back'
            ));
        }
        ...
        $this->_addButton('goto_logs_cleaning', array(
            ...
            'onclick'   => 'setLocation(\'' .$this->getUrl('*/adminhtml_logCleaning/index',array('back'=>Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_log/synchronization'))).'\')',
            'class'     => 'button_link'
        ));
