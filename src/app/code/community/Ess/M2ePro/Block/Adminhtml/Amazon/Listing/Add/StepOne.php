...
class Ess_M2ePro_Block_Adminhtml_Amazon_Listing_Add_StepOne extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_addButton('back', array(
            ...
            'onclick'   => 'AmazonListingSettingsHandlerObj.back_click(\'' .$this->getUrl('*/adminhtml_listing/index',array('tab' => Ess_M2ePro_Block_Adminhtml_Component_Abstract::TAB_ID_AMAZON)).'\')',
            'class'     => 'back'
        ));
        ...
        $this->_addButton('save_and_next', array(
            ...
            'onclick'   => 'AmazonListingSettingsHandlerObj.save_click(\''.$this->getUrl('*/adminhtml_amazon_listing/add',array('step'=>'1')).'\')',
            'class'     => 'next'
        ));
        //------------------------------
    }
