...
class Ess_M2ePro_Block_Adminhtml_Amazon_Listing_Add_StepTwo extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper('M2ePro')->__("Add{$componentName} Listing [Channel Settings]");
        //------------------------------
        ...
        $this->_addButton('back', array(
            ...
            'onclick'   => 'AmazonListingChannelSettingsHandlerObj.back_click(\'' .$this->getUrl('*/adminhtml_amazon_listing/add',array('step'=>'1')).'\')',
            'class'     => 'back'
        ));
        ...
        $this->_addButton('save_and_next', array(
            ...
            'onclick'   => 'AmazonListingChannelSettingsHandlerObj.save_click(\''.$this->getUrl('*/adminhtml_amazon_listing/add',array('step'=>'2')).'\')',
            'class'     => 'next'
        ));
        //------------------------------
    }
