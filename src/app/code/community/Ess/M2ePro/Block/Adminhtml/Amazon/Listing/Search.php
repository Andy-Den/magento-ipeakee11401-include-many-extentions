...
class Ess_M2ePro_Block_Adminhtml_Amazon_Listing_Search extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    ...
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper('M2ePro')->__("Search{$componentName} Listings Items");
        //------------------------------
        ...
        if (!is_null($this->getRequest()->getParam('back'))) {
            ...
            $this->_addButton('back', array(
                ...
                'onclick'   => 'CommonHandlerObj.back_click(\''.Mage::helper('M2ePro')->getBackUrl('*/adminhtml_amazon_listing/search').'\')',
                'class'     => 'back'
            ));
        }
        ...
        $this->_addButton('goto_listings', array(
            ...
            'onclick'   => 'setLocation(\''.$this->getUrl('*/adminhtml_listing/index',array('tab' => Ess_M2ePro_Block_Adminhtml_Component_Abstract::TAB_ID_AMAZON,'back'=>Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_amazon_listing/search'))).'\')',
            'class'     => 'button_link'
        ));
        ...
        $this->_addButton('view_log', array(
            ...
            'onclick'   => 'setLocation(\''.$this->getUrl('*/adminhtml_log/listing',array('back'=>Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_amazon_listing/search'), 'filter' => base64_encode('component_mode=' . Ess_M2ePro_Helper_Component_Amazon::NICK))).'\')',
            'class'     => 'button_link'
        ));
