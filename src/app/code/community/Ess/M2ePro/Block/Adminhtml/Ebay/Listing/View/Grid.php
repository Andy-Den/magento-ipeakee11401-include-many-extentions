...
class Ess_M2ePro_Block_Adminhtml_Ebay_Listing_View_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()
                   ...
                   ->joinLeft(array('mei'=>Mage::getResourceModel('M2ePro/Ebay_Item')->getMainTable()), '(`mei`.`id` = `second_table`.`ebay_item_id`)',array('item_id'));
        //--------------------------------
    ...
    public function callbackColumnEbayItemId($value, $row, $column, $isExport)
    {
        ...
        $value = '<a href="'.$this->getUrl('*/adminhtml_ebay_listing/goToEbay/', array('item_id' => $value)).'" target="_blank">'.$value.'</a>';
    ...
    public function callbackColumnOnlineStartPrice($value, $row, $column, $isExport)
    {
        ...
        return Mage::app()->getLocale()->currency($this->sellingFormatTemplate->getChildObject()->getCurrency())->toCurrency($value);
    }
