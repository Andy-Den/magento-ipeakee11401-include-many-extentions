...
JAVASCRIPT;
    ...
    public function getAmazonTabHtml()
    {
        ...
        return $javascript . $helpBlock->toHtml() . $filtersBlock->toHtml() . parent::getAmazonTabHtml();
    }
    ...
    {
        $tempGridIds = array();
        Mage::helper('M2ePro/Component_Ebay')->isEnabled()   && $tempGridIds[] = $this->getEbayTabBlock()->getId();
        Mage::helper('M2ePro/Component_Amazon')->isEnabled() && $tempGridIds[] = $this->getAmazonTabBlock()->getId();
