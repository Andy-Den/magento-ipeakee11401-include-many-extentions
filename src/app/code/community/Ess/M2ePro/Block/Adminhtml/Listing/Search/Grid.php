...
class Ess_M2ePro_Block_Adminhtml_Listing_Search_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->join(array('l'=>Mage::getResourceModel('M2ePro/Listing')->getMainTable()), '(`l`.`id` = `main_table`.`listing_id`)', array('listing_title'=>'title','store_id'));
        //--------------------------------
    ...
    public function callbackColumnActions($value, $row, $column, $isExport)
    {
        ...
        $link = $this->getUrl('*/adminhtml_'.$row->getData('component_mode').'_listing/view/',array('id'=>$row->getData('listing_id'),
