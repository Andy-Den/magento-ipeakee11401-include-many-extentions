...
class Ess_M2ePro_Block_Adminhtml_Amazon_Listing_Add_StepFour extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        ...
        //------------------------------
        $this->setId('amazonListingAddStepFour');
        ...
        $this->_addButton('back', array(
            ...
            'onclick'   => 'ProductGridHandlerObj.back_click(\'' .$this->getUrl('*/adminhtml_amazon_listing/add',array('step'=>'3')).'\')',
            'class'     => 'back'
        ));
