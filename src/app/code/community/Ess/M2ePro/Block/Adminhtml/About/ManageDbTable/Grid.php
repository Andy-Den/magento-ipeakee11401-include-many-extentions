...
class Ess_M2ePro_Block_Adminhtml_About_ManageDbTable_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $tableAction  = Mage::getSingleton('core/resource')->getTableName(Mage::helper('M2ePro')->getGlobalValue('data_table'));
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('delete', array(
             ...
             'url'      => $this->getUrl('*/*/deleteDbTableSelectedRows',array('model'=>Mage::helper('M2ePro')->getGlobalValue('data_model'), 'table'=>Mage::helper('M2ePro')->getGlobalValue('data_table'))),
    ...
    public function callbackColumnData($value, $row, $column, $isExport)
    {
        ...
        $tempUrl = $this->getUrl('*/*/updateDbTableCell',array('model'=>Mage::helper('M2ePro')->getGlobalValue('data_model'),'table'=>Mage::helper('M2ePro')->getGlobalValue('data_table'),'id'=>$row->getId(),'column'=>$column->getId()));
    ...
    public function callbackColumnActions($value, $row, $column, $isExport)
    {
        ...
        $tempUrl = $this->getUrl('*/*/deleteDbTableRow',array('model'=>Mage::helper('M2ePro')->getGlobalValue('data_model'),'table'=>Mage::helper('M2ePro')->getGlobalValue('data_table'),'id'=>$tempId));
