...
class Ess_M2ePro_Block_Adminhtml_Amazon_Listing_View extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        ...
        $this->_addButton('goto_listings', array(
            ...
            'onclick' => 'setLocation(\''.$this->getUrl('*/adminhtml_listing/index',array('tab' => Ess_M2ePro_Block_Adminhtml_Component_Abstract::TAB_ID_AMAZON)).'\')',
            'class'   => 'button_link'
        ));

        $this->_addButton('view_log', array(
            'label'   => Mage::helper('M2ePro')->__('View Log'),
            'onclick' => 'setLocation(\'' .$this->getUrl('*/adminhtml_log/listing',array('id'=>$listingData['id'],'back'=>Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_amazon_listing/view',array('id'=>$listingData['id'])))).'\')',
            'class'   => 'button_link'
        ));
        ...
        if (is_null($newListing)) {
            ...
            $this->_addButton('clear_log', array(
                ...
                'onclick' => 'deleteConfirm(\''.$tempStr.'\', \'' . $this->getUrl('*/adminhtml_listing/clearLog',array('id'=>$listingData['id'],'back'=>Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_amazon_listing/view',array('id'=>$listingData['id'])))) . '\')',
                'class'   => 'clear_log'
            ));
        }
        ...
        $this->_addButton('delete', array(
            ...
            'onclick' => 'deleteConfirm(\''. $tempStr.'\', \'' . $this->getUrl('*/adminhtml_'.Ess_M2ePro_Helper_Component_Amazon::NICK.'_listing/delete',array('id'=>$listingData['id'])) . '\')',
            'class'   => 'delete'
        ));
        ...
        $this->_addButton('edit_settings', array(
            ...
            'onclick'   => 'setLocation(\'' .$this->getUrl('*/adminhtml_amazon_listing/edit',array('id'=>$listingData['id'],'back'=>Mage::helper('M2ePro')->makeBackUrlParam('view',array('id'=>$listingData['id'])))).'\')',
            'class'     => ''
        ));

        $this->_addButton('add_products', array(
            'label'     => Mage::helper('M2ePro')->__('Add Products'),
            'onclick'   => 'setLocation(\'' .$this->getUrl('*/adminhtml_amazon_listing/product',array('id'=>$listingData['id'],'back'=>Mage::helper('M2ePro')->makeBackUrlParam('view',array('id'=>$listingData['id'])))).'\')',
            'class'     => 'add'
        ));
        //------------------------------
    }
    ...
    public function getGridHtml()
    {
        ...
        $logViewUrl = $this->getUrl('*/adminhtml_log/listing',array('id'=>$listingData['id'],'back'=>Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_amazon_listing/view',array('id'=>$listingData['id']))));
        $checkLockListing = $this->getUrl('*/adminhtml_listing/checkLockListing',array('component'=>Ess_M2ePro_Helper_Component_Amazon::NICK));
        $lockListingNow = $this->getUrl('*/adminhtml_listing/lockListingNow',array('component'=>Ess_M2ePro_Helper_Component_Amazon::NICK));
        $unlockListingNow = $this->getUrl('*/adminhtml_listing/unlockListingNow',array('component'=>Ess_M2ePro_Helper_Component_Amazon::NICK));
        ...
        $taskCompletedSuccessMessage = Mage::helper('M2ePro')->escapeJs(Mage::helper('M2ePro')->__('"%title%" task has successfully submitted for processing.'));
        ...
        $lockedObjNoticeMessage = Mage::helper('M2ePro')->escapeJs(Mage::helper('M2ePro')->__('TODO TEXT Amazon processing now'));
        $sendingDataToAmazonMessage = Mage::helper('M2ePro')->escapeJs(Mage::helper('M2ePro')->__('Sending %execute% product(s) data on Amazon.'));
        ...
        $stoppingAndRemovingSelectedItemsMessage = Mage::helper('M2ePro')->escapeJs(Mage::helper('M2ePro')->__('Stopping And Removing Selected Items On Amazon'));
...
<ul style="display: none;">
    <li href="{$this->getUrl('*/adminhtml_amazon_template_sellingFormat/edit',array('id'=>$listingData['template_selling_format_id']))}" target="_blank">{$sellingFormatTemplate}</li>
    <li href="{$this->getUrl('*/adminhtml_amazon_template_description/edit',array('id'=>$listingData['template_description_id']))}" target="_blank">{$descriptionTemplate}</li>
    <li href="{$this->getUrl('*/adminhtml_amazon_template_synchronization/edit',array('id'=>$listingData['template_synchronization_id']))}" target="_blank">{$synchronizationTemplate}</li>
</ul>
HTML;
    }
}