    ...
    protected function _beforeToHtml()
    {
        ...
        $buttonBlock = $this->getLayout()
                            ...
                            ->setData( array(
                                ...
                                'onclick' => 'WizardHandlerObj.processStep(\''.$this->getUrl('*/adminhtml_settings/index').'\','.Ess_M2ePro_Model_Wizard::STATUS_SETTINGS.', WizardHandlerObj.callBackAfterSettings);',
