...
class Ess_M2ePro_Block_Adminhtml_Listing_Other_MapToProduct_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    public function callbackColumnTitle($value, $row, $column, $isExport)
    {
        ...
        $value .= '<br/><strong>'.Mage::helper('M2ePro')->__('SKU').':</strong> '.Mage::helper('M2ePro')->escapeHtml($tempSku).'</div>';
    ...
    {
        return '&nbsp;<a href="javascript:void(0);" onclick="$(\'product_id\').setValue(\''.$row->getId().'\'); $(\'sku\').setValue(\'\'); $(\'help_grid\').hide(); $$(\'.mapToProduct_submit_button\')[0].click();">'.Mage::helper('M2ePro')->__('Map To This Product').'</a>';
