    ...
    public function __construct()
    {
        ...
        if (!is_null($this->getRequest()->getParam('back'))) {
            ...
            $this->_addButton('back', array(
                ...
                'onclick'   => 'EbayListingEditHandlerObj.back_click(\''.Mage::helper('M2ePro')->getBackUrl('*/adminhtml_listing/index',array('tab' => Ess_M2ePro_Block_Adminhtml_Component_Abstract::TAB_ID_EBAY)).'\')',
                'class'     => 'back'
            ));
        }
        ...
        $this->_addButton('save', array(
            ...
            'onclick'   => 'EbayListingEditHandlerObj.save_click(\''.$this->getUrl('*/adminhtml_ebay_listing/save',array('id' => $listingData['id'],'back' => Mage::helper('M2ePro')->getBackUrlParam('list'))).'\')',
            'class'     => 'save'
        ));
