...
abstract class Ess_M2ePro_Block_Adminhtml_Component_Abstract extends Mage_Adminhtml_Block_Widget_Container
{
    ...
    public function disableEbayTab()
    {
        $this->disableTab(self::TAB_ID_EBAY);
    }

    public function disableAmazonTab()
    {
        $this->disableTab(self::TAB_ID_AMAZON);
    }
    ...
    {
        return !in_array($id, $this->disabledTabs);
    }
    ...
    {
        if (count($this->getComponentHelper()->getEnabledComponents()) == 0) {
