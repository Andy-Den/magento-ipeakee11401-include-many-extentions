...
class Ess_M2ePro_Block_Adminhtml_Amazon_Listing_Edit_Tabs_Settings extends Mage_Adminhtml_Block_Widget
{
    ...
    protected function _beforeToHtml()
    {
        ...
        //----------------------------
        $this->sellingFormatTemplatesDropDown = Mage::helper('M2ePro/Component_Amazon')->getCollection('Template_SellingFormat')->getSize() < $maxRecordsQuantity;
        $this->descriptionsTemplatesDropDown = Mage::helper('M2ePro/Component_Amazon')->getCollection('Template_Description')->getSize() < $maxRecordsQuantity;
        //----------------------------

        //----------------------------
        $synchronizationTemplatesCollection = Mage::helper('M2ePro/Component_Amazon')->getCollection('Template_Synchronization')->setOrder('title', 'ASC');
        ...
        $buttonBlock = $this->getLayout()
                            ...
                            ->setData( array(
                                ...
                                'onclick' => 'AmazonListingSettingsHandlerObj.openWindow(\'' . $this->getUrl('*/adminhtml_amazon_template_sellingFormat/new') . '\');',
        ...
        $buttonBlock = $this->getLayout()
                            ...
                            ->setData( array(
                                'label'   => Mage::helper('M2ePro')->__('Add New'),
                                'onclick' => 'AmazonListingSettingsHandlerObj.openWindow(\'' . $this->getUrl('*/adminhtml_amazon_template_description/new') . '\');',
        ...
        $buttonBlock = $this->getLayout()
                            ...
                            ->setData( array(
                                'label'   => Mage::helper('M2ePro')->__('Add New'),
                                'onclick' => 'AmazonListingSettingsHandlerObj.openWindow(\'' . $this->getUrl('*/adminhtml_amazon_template_synchronization/new') . '\');',
