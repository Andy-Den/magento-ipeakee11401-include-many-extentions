...
class Ess_M2ePro_Block_Adminhtml_Template_Description_Grid extends Ess_M2ePro_Block_Adminhtml_Component_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        if (count(Mage::helper('M2ePro/Component')->getEnabledComponents()) == 1) {
            Mage::helper('M2ePro/Component_Ebay')->isEnabled()   && $collection->addFieldToFilter('component_mode', Ess_M2ePro_Helper_Component_Ebay::NICK);
            Mage::helper('M2ePro/Component_Amazon')->isEnabled() && $collection->addFieldToFilter('component_mode', Ess_M2ePro_Helper_Component_Amazon::NICK);
        }
