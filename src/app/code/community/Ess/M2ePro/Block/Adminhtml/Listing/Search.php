    ...
    public function __construct()
    {
        ...
        if (!is_null($this->getRequest()->getParam('back'))) {
            ...
            $this->_addButton('back', array(
                ...
                'onclick'   => 'CommonHandlerObj.back_click(\''.Mage::helper('M2ePro')->getBackUrl('*/adminhtml_listing/search').'\')',
                'class'     => 'back'
            ));
        }
        ...
        $this->_addButton('goto_listings', array(
            ...
            'onclick'   => 'setLocation(\''.$this->getUrl('*/adminhtml_listing/index',array('back'=>Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_listing/search'))).'\')',
            'class'     => 'button_link'
        ));
        ...
        $this->_addButton('view_log', array(
            ...
            'onclick'   => 'setLocation(\''.$this->getUrl('*/adminhtml_log/listing',array('back'=>Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_listing/search'))).'\')',
            'class'     => 'button_link'
        ));
...
<ul style="display: none;">
    <li href="{$this->getUrl('*/adminhtml_template_sellingFormat/index')}" target="_blank">{$sellingFormatTemplate}</li>
    <li href="{$this->getUrl('*/adminhtml_template_description/index')}" target="_blank">{$descriptionTemplate}</li>
    <li href="{$this->getUrl('*/adminhtml_template_general/index')}" target="_blank">{$generalTemplate}</li>
    <li href="{$this->getUrl('*/adminhtml_template_synchronization/index')}" target="_blank">{$synchronizationTemplate}</li>
</ul>
HTML;
    }
