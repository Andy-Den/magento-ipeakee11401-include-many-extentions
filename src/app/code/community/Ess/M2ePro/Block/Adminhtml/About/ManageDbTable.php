...
class Ess_M2ePro_Block_Adminhtml_About_ManageDbTable extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        ...
        // Set header text
        //------------------------------
        $this->_headerText = Mage::helper('M2ePro')->__('Manage DB Table "'.Mage::helper('M2ePro')->getGlobalValue('data_table').'"');
        //------------------------------
        ...
        $this->_addButton('delete_all', array(
            ...
            'onclick'   => 'deleteConfirm(\''. Mage::helper('M2ePro')->__('Are you sure?').'\', \'' . $this->getUrl('*/*/deleteDbTableAll',array('table'=>Mage::helper('M2ePro')->getGlobalValue('data_table'),'model'=>Mage::helper('M2ePro')->getGlobalValue('data_model'))) . '\')',
            'class'     => 'delete_all'
        ));
