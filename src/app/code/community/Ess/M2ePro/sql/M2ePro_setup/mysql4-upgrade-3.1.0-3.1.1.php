...
$status = $installer->getConnection()
                    ->query("SELECT `value` FROM `m2epro_config`
                             WHERE  `group` = '/migrate/'
...
if ((bool)$status) {
    ...
    $listingsTemplates = $installer->getConnection()
                                   ->query('SELECT * FROM `m2epro_listings_templates`')
                                   ->fetchAll();
    foreach ($listingsTemplates as $listingTemplate) {
        ...
        if (isset($productDetails[$modeName]) &&
            ...
            } else if ($productDetails[$modeName] == 2 && $productDetails[$CVName] == '' && $productDetails[$CAName] != '') {
        ...
        if (isset($productDetails[$modeName]) &&
            ...
            if ($productDetails[$modeName] == 0 && $productDetails[$CVName] != '' && $productDetails[$CAName] == '') {
                $productDetails[$modeName] = 1;
            } else if ($productDetails[$modeName] == 1 && $productDetails[$CVName] == '' && $productDetails[$CAName] != '') {
                $productDetails[$modeName] = 2;
            }
        }
        ...
        $installer->getConnection()
                   ->query("UPDATE `m2epro_listings_templates`
