...
class Celebros_Salesperson_Model_Product extends Celebros_Salesperson_Model_Api_QwiserProduct
{
	...
	*/
	...
	{
		return $this->Field[Mage::Helper('salesperson/mapping')->getMapping('link')];
	}
...
//		$isInStock = $inventoery->getData('is_in_stock');
//		if ((int)$isInStock == 0){ return false; }else { return true; }
		return ((key_exists(Mage::Helper('salesperson/mapping')->getMapping('is_saleable'), $this->Field)) && ((int)$this->Field[Mage::Helper('salesperson/mapping')->getMapping('is_saleable')])) == 0 ? false : true;
	}
	...
	{
		$id = $this->Field[Mage::Helper('salesperson/mapping')->getMapping('id')];
