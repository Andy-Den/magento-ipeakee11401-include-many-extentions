...
abstract class Celebros_Salesperson_Block_Product_Abstract extends  Mage_Catalog_Block_Product_Abstract
{
    ...
    public function getPriceHtml($product, $displayMinimalPrice = false, $idSuffix='')
    {
        ...
        $mageProduct = $product->getRealProduct();
    	return parent::getPriceHtml($mageProduct, $displayMinimalPrice = false, $idSuffix='');
        
        /*$id = $product->Field[$this->getMapping('id')];
    ...
    {
		return isset($product->Field[$this->getMapping('link')]) ? $product->Field[$this->getMapping('link')] : '';
    }
