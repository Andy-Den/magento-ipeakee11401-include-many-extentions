...
class IG_LightBox2_Block_Catalog_Product_View_Media_Gallery_Lightbox extends IG_LightBox2_Block_Catalog_Product_View_Media_Gallery
{
	...
	protected $_jsList = array(
		'ig_lightbox2/lightbox/js/jquery.lightbox-0.5.js',
	);
	...
	protected function getParams()
	{
		...
		$return['imageBtnClose'] = $this->getSkinUrl('ig_lightbox2/lightbox/images/fancy_close.png');
		$return['imageBtnPrev'] = $this->getSkinUrl('ig_lightbox2/lightbox/images/fancy_nav_left.png');
		$return['imageBtnNext'] = $this->getSkinUrl('ig_lightbox2/lightbox/images/fancy_nav_right.png');
