...
class Magazento_Megamenu_Adminhtml_Magazento_Megamenu_CategoryController extends Mage_Adminhtml_Controller_Action {
    ...
    public function editAction() {
        ...
        $this->_initAction()
                ...
                ->_addContent($this->getLayout()->createBlock('megamenu/admin_category_edit')->setData('action', $this->getUrl('*/magazento_megamenu_category/save')))
