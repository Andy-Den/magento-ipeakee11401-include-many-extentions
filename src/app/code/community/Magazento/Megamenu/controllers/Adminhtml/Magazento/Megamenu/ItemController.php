...
class Magazento_Megamenu_Adminhtml_Magazento_Megamenu_ItemController extends Mage_Adminhtml_Controller_Action {
    ...
    public function editAction() {
        ...
        $this->_initAction()
                ...
                ->_addContent($this->getLayout()->createBlock('megamenu/admin_item_edit')->setData('action', $this->getUrl('*/magazento_megamenu_item/save')))
