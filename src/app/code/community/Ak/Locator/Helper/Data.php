...
class Ak_Locator_Helper_Data extends Ak_Locator_Helper_Abstract
{
    ...
    /*set text button search*/
    public function setTextButton($text = '')
    {
        if($text != null) {
            $this->_textButtonSearch = $text;
        }
        return $this->_textButtonSearch;
    }

    public function isDetailPage($val = '')
    {
        if($val != null) {
            $this->_isDetail = $val;
        }
